...
public final class GreetingServiceGrpc {
  ...
  public static final String SERVICE_NAME = "com.evo.apatrios.grpc.GreetingService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.evo.apatrios.grpc.GreetingServiceOuterClass.HelloRequest,
      com.evo.apatrios.grpc.GreetingServiceOuterClass.HelloResponse> getGreetingMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "greeting",
      requestType = com.evo.apatrios.grpc.GreetingServiceOuterClass.HelloRequest.class,
      responseType = com.evo.apatrios.grpc.GreetingServiceOuterClass.HelloResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
  public static io.grpc.MethodDescriptor<com.evo.apatrios.grpc.GreetingServiceOuterClass.HelloRequest,
      com.evo.apatrios.grpc.GreetingServiceOuterClass.HelloResponse> getGreetingMethod() {
    io.grpc.MethodDescriptor<com.evo.apatrios.grpc.GreetingServiceOuterClass.HelloRequest, com.evo.apatrios.grpc.GreetingServiceOuterClass.HelloResponse> getGreetingMethod;
      ...
      synchronized (GreetingServiceGrpc.class) {
        if ((getGreetingMethod = GreetingServiceGrpc.getGreetingMethod) == null) {
          GreetingServiceGrpc.getGreetingMethod = getGreetingMethod =
              io.grpc.MethodDescriptor.<com.evo.apatrios.grpc.GreetingServiceOuterClass.HelloRequest, com.evo.apatrios.grpc.GreetingServiceOuterClass.HelloResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "greeting"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.evo.apatrios.grpc.GreetingServiceOuterClass.HelloRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.evo.apatrios.grpc.GreetingServiceOuterClass.HelloResponse.getDefaultInstance()))
  ...
  public static abstract class GreetingServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void greeting(com.evo.apatrios.grpc.GreetingServiceOuterClass.HelloRequest request,
        io.grpc.stub.StreamObserver<com.evo.apatrios.grpc.GreetingServiceOuterClass.HelloResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncServerStreamingCall(
              new MethodHandlers<
                com.evo.apatrios.grpc.GreetingServiceOuterClass.HelloRequest,
                com.evo.apatrios.grpc.GreetingServiceOuterClass.HelloResponse>(
  ...
  public static final class GreetingServiceBlockingStub extends io.grpc.stub.AbstractStub<GreetingServiceBlockingStub> {
    ...
    /**
     */
    public java.util.Iterator<com.evo.apatrios.grpc.GreetingServiceOuterClass.HelloResponse> greeting(
        com.evo.apatrios.grpc.GreetingServiceOuterClass.HelloRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GREETING:
          serviceImpl.greeting((com.evo.apatrios.grpc.GreetingServiceOuterClass.HelloRequest) request,
              (io.grpc.stub.StreamObserver<com.evo.apatrios.grpc.GreetingServiceOuterClass.HelloResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class GreetingServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.evo.apatrios.grpc.GreetingServiceOuterClass.getDescriptor();
    }
